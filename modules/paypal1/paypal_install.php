...
class PayPalInstall
{
	...
	public function updateConfiguration($paypal_version)
	{
		...
		Configuration::updateValue('PAYPAL_FEESPERCENT', 0.00);
		Configuration::updateValue('PAYPAL_FEESPERCENT_NAME', 'Transaction fee');
		//Configuration::updateValue('PAYPAL_FEESPERCENT_NAME', array($this->context->language->id =>$this->l('Transaction fee')));
		//Configuration::updateValue('PAYPAL_FEESPERCENT_DESC', array($this->context->language->id =>$this->l('Transaction fee description')));
		Configuration::updateValue('PAYPAL_FEESPERCENT_DESC', 'Transaction fee percentage');
	...
	public function deleteConfiguration()
	{
		...
		Configuration::deleteByName('PAYPAL_FEESPERCENT');
