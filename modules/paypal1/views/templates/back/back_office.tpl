...
<div id="paypal-wrapper">
	...
	<div class="clear"></div><hr />
	<h4>{$PayPal_content.fees_percent_title}</h4>
	<dl>
		<dt><label for="api_fees_percent">{$PayPal_content.fees_percent} : </label></dt>
		<dd><input type='text' name="fees_percent" id="fees_percent" value="{$PayPal_fees_percent}" autocomplete="off" /></dd>
		
		<dt><label for="fees_percent_name">{$PayPal_content.fees_percent_name} : </label></dt>
		...
		<dd><input type='text' name="fees_percent_name_{$language.id_lang}" id="fees_percent_name_{$language.id_lang}" value="{$PayPal_fees_percent_name[$language['id_lang']]}" autocomplete="off" /> <img src="../img/l/{$language.id_lang}.jpg" alt="{$language.iso_code}" width="16" height="11" /></dd>

		{/if}
		{/foreach}
		
		<dt><label for="api_fees_percent">{$PayPal_content.fees_percent_desc} : </label></dt>

		
		{foreach from=$languages item=language}
		{if $language.active == 1}
		<dd><input type='text' name="fees_percent_desc_{$language.id_lang}" id="fees_percent_desc_{$language.id_lang}" value="{$PayPal_fees_percent_desc[$language['id_lang']]}" autocomplete="off" /> <img src="../img/l/{$language.id_lang}.jpg" alt="{$language.iso_code}" width="16" height="11" /></dd>
		...
		&nbsp;&nbsp;<span class="description">{$PayPal_content.fees_percent_description}</span>
