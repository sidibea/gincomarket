...
class Pay
{
	...
	static $ipnNotificationUrl ="ipnNotificationUrl";
	static $currencyCode ="currencyCode";
	 static $receiverAmount= array(
			 ...
			 "receiverList.receiver[0].primary",
			 "receiverList.receiver[1].primary",
			 "receiverList.receiver[2].primary",
			 "receiverList.receiver[3].primary",
			 "receiverList.receiver[4].primary",
			 "receiverList.receiver[5].primary",			 
			);
