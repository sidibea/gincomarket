...
class GroupCategoryThumb {
	 ...
	 */
    public static function pCreateFull($sourceFile, $newPath, $newName = '', $ext='.jpg', $maxWidth = 250, $maxHeight = 250, $quantity = 90, $text = '', $delete=false){
    	if($newName){		
