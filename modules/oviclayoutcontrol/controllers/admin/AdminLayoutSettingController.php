...
class AdminLayoutSettingController extends ModuleAdminController {
    ...
    public function renderList(){
        ...
        if ($view =='default'){
            ...
            */
            ...
            $current_id_option = Configuration::get('OVIC_CURRENT_OPTION', null, null, Context::getContext()->shop->id);
            if ($options && is_array($options) && sizeof($options)>0){
                ...
                $selected_layout = Configuration::get('OVIC_LAYOUT_COLUMN', null, null, Context::getContext()->shop->id);
    ...
    public function renderForm()
	{
		...
		$helper->tpl_vars = array(
			'fields_value' => array(
                'id_tab' => 1,
                'FONT_LINK'=> html_entity_decode(Tools::getValue('FONT_LINK',Configuration::get('OVIC_FONT_LINK', null, null, Context::getContext()->shop->id))),
                'MAIN_COLOR'=> Tools::getValue('MAIN_COLOR',Configuration::get('OVIC_MAIN_COLOR', null, null, Context::getContext()->shop->id)),
                'BTN_COLOR'=> Tools::getValue('BTN_COLOR',Configuration::get('OVIC_BTN_COLOR', null, null, Context::getContext()->shop->id)),
                'BTN_HOVER_COLOR'=> Tools::getValue('BTN_HOVER_COLOR',Configuration::get('OVIC_BTN_HOVER_COLOR', null, null, Context::getContext()->shop->id)),
                'BTN_TEXT_COLOR'=> Tools::getValue('BTN_COLOR',Configuration::get('OVIC_BTN_TEXT_COLOR', null, null, Context::getContext()->shop->id)),
                'BTN_TEXT_HOVER_COLOR'=> Tools::getValue('BTN_HOVER_COLOR',Configuration::get('OVIC_BTN_TEXT_HOVER_COLOR', null, null, Context::getContext()->shop->id)),
            ),
    ...
    private function ProcessLayoutColumn(){
        $theme = new Theme((int)$this->context->shop->id_theme);
        $layoutColumn = (int)Configuration::get('OVIC_LAYOUT_COLUMN', null, null, Context::getContext()->shop->id);
