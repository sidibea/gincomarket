<?php
    ...
    // $transaction = 1;   // Transactional sms for india and UAE, otherwise promotional SMS
    

    $status = "";
    $query = "to=".$to."&text=".$text."&unicode=".$unicode."&type=".$type."&transaction=".$transaction;
    ...
    {
        fwrite($fp, "POST ".$folder."/modules/prestasms/api.php HTTP/1.0\r\n");
