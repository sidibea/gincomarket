...
include_once(_PS_MODULE_DIR_.'/prestasms/includes/controller/statistics.php');
include_once(_PS_MODULE_DIR_.'/prestasms/exc.php'); 

class SmsStatistics extends AdminTab
{
    ...
    {
        $this->sms = new ControllerSmsStatistics();
        parent::__construct();
    }
    ...
    public function display()
    {
        ...
        echo "<link rel=\"stylesheet\" type=\"text/css\" href=\"../modules/prestasms/css/jquery.datetimepicker.css\">";
