<?php /* Smarty version Smarty-3.1.19, created on 2017-04-27 13:39:20
         compiled from "/home/abdouhanne/www/pr/themes/supershop/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19428947415901f488ab5b27-56415231%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3642653de81b6f3bbfc2776d0d71ada3cbf43174' => 
    array (
      0 => '/home/abdouhanne/www/pr/themes/supershop/product.tpl',
      1 => 1492385467,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19428947415901f488ab5b27-56415231',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5901f48914d213_82311930',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5901f48914d213_82311930')) {function content_5901f48914d213_82311930($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/abdouhanne/www/pr/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/home/abdouhanne/www/pr/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_cycle')) include '/home/abdouhanne/www/pr/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_counter')) include '/home/abdouhanne/www/pr/tools/smarty/plugins/function.counter.php';
?>
...
<?php if (count($_smarty_tpl->tpl_vars['errors']->value)==0) {?>
	...
	<?php }?>
    <?php if (isset($_smarty_tpl->tpl_vars['compared_products']->value)) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['addJsDef'][0][0]->addJsDef(array('comparedProductsIds'=>$_smarty_tpl->tpl_vars['compared_products']->value),$_smarty_tpl);?>
<?php }?>
		...
		<div class="pb-left-column col-xs-12 col-sm-4 col-md-5">
			...
			<div id="image-block" class="clearfix">
				...
				<?php if ($_smarty_tpl->tpl_vars['product']->value->on_sale) {?>
					<span class="sale-box no-print<?php if (!$_smarty_tpl->tpl_vars['product']->value->new) {?> no-new<?php }?>">
...
<?php }?>"/>
                            ...
                            <?php if (!$_smarty_tpl->tpl_vars['content_only']->value&&$_smarty_tpl->tpl_vars['jqZoomEnabled']->value) {?>
								<span class="span_link no-print"><i class="fa fa-search"></i>&nbsp;<?php echo smartyTranslate(array('s'=>'Mouse over to zoom in'),$_smarty_tpl);?>
</span>
							<?php }?>
						<?php } else { ?>
...
"/>
						<?php if (!$_smarty_tpl->tpl_vars['content_only']->value) {?>
							<span class="span_link">
								<i class="fa fa-search"></i>&nbsp;<?php echo smartyTranslate(array('s'=>'Mouse over to zoom in'),$_smarty_tpl);?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['packItem']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
			...
			<section class="page-product-box">
				<h3 class="page-product-heading" style="font-size: 14px; font-weight: bold"><?php echo smartyTranslate(array('s'=>'Attachments'),$_smarty_tpl);?>
: </h3>
...
?>
					<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['attachements']['iteration']%3==1) {?><div class="row"><?php }?>
						<div class="col-lg-12">
							<div><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['attachment']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
 <small>(<?php echo Tools::formatBytes($_smarty_tpl->tpl_vars['attachment']->value['file_size'],2);?>
)</small> - <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('attachment',true,null,"id_attachment=".((string)$_smarty_tpl->tpl_vars['attachment']->value['id_attachment'])), ENT_QUOTES, 'UTF-8', true);?>
"><?php echo smartyTranslate(array('s'=>"Download"),$_smarty_tpl);?>
</a></div>
							<p class="text-muted" style="font-style: italic"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['attachment']->value['description'], ENT_QUOTES, 'UTF-8', true);?>
</p>
							<!--
				...
				<div class="box-info-product">
					<div class="content_prices clearfix">
						<?php if ($_smarty_tpl->tpl_vars['product']->value->show_price&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
                            ...
                            <!-- prices -->
							<div class="price">
                                <label><?php echo smartyTranslate(array('s'=>'Price'),$_smarty_tpl);?>
</label>
...
<?php }?></span> <?php echo smartyTranslate(array('s'=>'for ecotax'),$_smarty_tpl);?>
 ...
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->unity, ENT_QUOTES, 'UTF-8', true);?>
                ...
                <div id="box-product" class="col-sm-12">
                    ...
                    <?php echo $_smarty_tpl->tpl_vars['HOOK_OVIC_CATEGORYSIZECHART']->value;?>
...
?>
									<?php if (count($_smarty_tpl->tpl_vars['group']->value['attributes'])) {?>
										<fieldset class="attribute_fieldset">
											<label class="attribute_label<?php if ($_smarty_tpl->tpl_vars['group']->value['group_type']=='color') {?> label_color<?php }?>" <?php if ($_smarty_tpl->tpl_vars['group']->value['group_type']!='color'&&$_smarty_tpl->tpl_vars['group']->value['group_type']!='radio') {?>for="group_<?php echo intval($_smarty_tpl->tpl_vars['id_attribute_group']->value);?>
...
?>
															<li>
                                                                <input type="radio" id="<?php echo $_smarty_tpl->tpl_vars['id_attribute']->value;?>
" class="attribute_radio" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['groupName']->value, ENT_QUOTES, 'UTF-8', true);?>
...
" <?php if (($_smarty_tpl->tpl_vars['group']->value['default']==$_smarty_tpl->tpl_vars['id_attribute']->value)) {?> checked="checked"<?php }?> />
																<label class="label_radio <?php if (($_smarty_tpl->tpl_vars['group']->value['default']==$_smarty_tpl->tpl_vars['id_attribute']->value)) {?> checked<?php }?>" for="<?php echo $_smarty_tpl->tpl_vars['id_attribute']->value;?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_attribute']->value, ENT_QUOTES, 'UTF-8', true);?>
</label>
															</li>
														<?php } ?>
                    ...
                    <div class="box-cart-bottom">
						...
						<?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
					 	<p id="quantity_wanted_p"<?php if ((!$_smarty_tpl->tpl_vars['allow_oosp']->value&&$_smarty_tpl->tpl_vars['product']->value->quantity<=0)||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> style="display: none;"<?php }?>>
							<label><?php echo smartyTranslate(array('s'=>'Qty'),$_smarty_tpl);?>
</label>
...
<?php } else { ?>1<?php }?><?php }?>" />    
						...
						<p id="add_to_cart" class="buttons_bottom_block no-print <?php if ((!$_smarty_tpl->tpl_vars['allow_oosp']->value&&$_smarty_tpl->tpl_vars['product']->value->quantity<=0)||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||(isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&$_smarty_tpl->tpl_vars['restricted_country_mode']->value)||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> unvisible<?php }?>">
							<button type="submit" name="Submit" class="exclusive">
								<span><i class="fa fa-shopping-cart"></i><?php if ($_smarty_tpl->tpl_vars['content_only']->value&&(isset($_smarty_tpl->tpl_vars['product']->value->customization_required)&&$_smarty_tpl->tpl_vars['product']->value->customization_required)) {?><?php echo smartyTranslate(array('s'=>'Customize'),$_smarty_tpl);?>
...
<?php }?>
                        <a class="add_to_compare" id="add_to_compare" href="javascript:void(0)" data-id-product="<?php echo intval($_smarty_tpl->tpl_vars['product']->value->id);?>
...
<?php }?>
					<li class="print">
						<a href="javascript:print();" title="<?php echo smartyTranslate(array('s'=>'Print'),$_smarty_tpl);?>
">
     ...
     <div id="tab-container" class="col-xs-12">
        ...
        <ul id="product-tabs" class="nav nav-tabs" role="tablist">
            <?php if (isset($_smarty_tpl->tpl_vars['product']->value)&&$_smarty_tpl->tpl_vars['product']->value->description) {?>
                <li><a href="#descripntion-tab" role="tab" data-toggle="tab"><?php echo smartyTranslate(array('s'=>'Product Details'),$_smarty_tpl);?>
</a></li><?php }?>
            <?php if (isset($_smarty_tpl->tpl_vars['features']->value)&&$_smarty_tpl->tpl_vars['features']->value) {?>
                <li><a href="#table-data-sheet" role="tab" data-toggle="tab"><?php echo smartyTranslate(array('s'=>'Information'),$_smarty_tpl);?>
</a></li><?php }?>
            <?php if ((isset($_smarty_tpl->tpl_vars['quantity_discounts']->value)&&count($_smarty_tpl->tpl_vars['quantity_discounts']->value)>0)) {?>
                <li><a href="#quantityDiscount-tab" role="tab" data-toggle="tab"><?php echo smartyTranslate(array('s'=>'Discounts'),$_smarty_tpl);?>
</a></li><?php }?>
            <?php if ($_smarty_tpl->tpl_vars['HOOK_PRODUCT_TAB']->value) {?>
        ...
        <div id="product-tab-content" class="tab-content">
          <?php if (isset($_smarty_tpl->tpl_vars['product']->value)&&$_smarty_tpl->tpl_vars['product']->value->description) {?>
            <div class="tab-pane fade in" id="descripntion-tab">
...
?>
                    <?php if (!isset($_smarty_tpl->tpl_vars['feature']->value['id_product'])) {?>
...
<?php }?>
	...
	<!--Customization -->
	<section class="page-product-box">
		<h3 class="productscategory_h3 page-product-heading" style="margin-top:0px; text-transform: uppercase; font-size: 18px;"><?php echo smartyTranslate(array('s'=>'Product customization'),$_smarty_tpl);?>
</h3>
...
" enctype="multipart/form-data" id="customizationForm" class="clearfix">
			<p class="infoCustomizable" style="margin-bottom: 15px; font-style: italic;">
...
" class="customization_delete_icon" width="11" height="13" />
									...
									<div class="customizationUploadBrowse form-group">
										<label class="customizationUploadBrowseDescription">
											...
											<?php }?>
											<?php if ($_smarty_tpl->tpl_vars['field']->value['required']) {?><span style="color:#e62e04">*</span><?php }?>
										</label>
...
loader.gif" alt="loader" />
		...
		<p class="clear required"><span style="color:#e62e04">*</span> <?php echo smartyTranslate(array('s'=>'required fields'),$_smarty_tpl);?>
</p>
	</section>
	<!--end Customization -->
	<?php }?>
	<?php if (!$_smarty_tpl->tpl_vars['content_only']->value&&isset($_smarty_tpl->tpl_vars['accessories']->value)&&$_smarty_tpl->tpl_vars['accessories']->value) {?>
		<!--Accessories -->
		<section class="page-product-box">
