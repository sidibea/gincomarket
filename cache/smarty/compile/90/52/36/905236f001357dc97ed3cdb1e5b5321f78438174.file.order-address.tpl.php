<?php /* Smarty version Smarty-3.1.19, created on 2018-06-05 01:46:28
         compiled from "/home/abdouhanne/www/themes/supershop/order-address.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13372635685b15eb740e9913-13111067%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '905236f001357dc97ed3cdb1e5b5321f78438174' => 
    array (
      0 => '/home/abdouhanne/www/themes/supershop/order-address.tpl',
      1 => 1493588700,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13372635685b15eb740e9913-13111067',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b15eb74204ac6_53945112',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b15eb74204ac6_53945112')) {function content_5b15eb74204ac6_53945112($_smarty_tpl) {?>
...
"<?php if ($_smarty_tpl->tpl_vars['addresses']->value[$_smarty_tpl->getVariable('smarty')->value['section']['address']['index']]['id_address']==$_smarty_tpl->tpl_vars['cart']->value->id_address_invoice&&$_smarty_tpl->tpl_vars['cart']->value->id_address_delivery!=$_smarty_tpl->tpl_vars['cart']->value->id_address_invoice) {?> selected="selected"<?php }?>>
				...
				<?php } else { ?>
					<a href="<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "&mod=";?><?php echo (string)$_smarty_tpl->tpl_vars['back']->value;?><?php }?><?php $_tmp3=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1&select_address=1".$_tmp3), ENT_QUOTES, 'UTF-8', true);?>
...
" />
				<a href="<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "&back=";?><?php echo (string)$_smarty_tpl->tpl_vars['back']->value;?><?php }?><?php $_tmp5=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink($_smarty_tpl->tpl_vars['back_order_page']->value,true,null,"step=0".$_tmp5), ENT_QUOTES, 'UTF-8', true);?>
