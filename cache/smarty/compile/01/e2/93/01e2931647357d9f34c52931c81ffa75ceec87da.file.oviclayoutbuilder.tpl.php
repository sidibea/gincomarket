<?php /* Smarty version Smarty-3.1.19, created on 2017-04-30 16:41:29
         compiled from "/home/abdouhanne/www/pr/modules/oviclayoutcontrol/views/templates/admin/layout_builder/oviclayoutbuilder.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1546725277590613b9223781-44145770%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '01e2931647357d9f34c52931c81ffa75ceec87da' => 
    array (
      0 => '/home/abdouhanne/www/pr/modules/oviclayoutcontrol/views/templates/admin/layout_builder/oviclayoutbuilder.tpl',
      1 => 1492385467,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1546725277590613b9223781-44145770',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_590613b95cc1e9_18828557',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_590613b95cc1e9_18828557')) {function content_590613b95cc1e9_18828557($_smarty_tpl) {?><div id="ovicLayoutSeting">
...
/img/full.png" alt=""/>
                            ...
                            <td><?php if ($_smarty_tpl->tpl_vars['option']->value['image']) {?><img class="img-thumbnail" src="<?php echo $_smarty_tpl->tpl_vars['thumbnails_dir']->value;?>
...
" <?php if ($_smarty_tpl->tpl_vars['langguages']->value['default_lang']!=$_smarty_tpl->tpl_vars['lang']->value['id_lang']) {?>style="display:none"<?php }?>>
    				            <div class="col-lg-9">
    				                <input class="form-control" type="text" id="option_name" name="option_name_<?php echo $_smarty_tpl->tpl_vars['lang']->value['id_lang'];?>
" value="<?php if (isset($_smarty_tpl->tpl_vars['option']->value->name[$_smarty_tpl->tpl_vars['lang']->value['id_lang']])) {?><?php echo $_smarty_tpl->tpl_vars['option']->value->name[$_smarty_tpl->tpl_vars['lang']->value['id_lang']];?>
<?php }?>"/>
    				            </div>
    							<div class="col-lg-2">
...
<?php } else { ?>0<?php }?>" />
                                <input class="colsetting multiselect" type="checkbox" name="colsetting" id="3column" <?php if (isset($_smarty_tpl->tpl_vars['option']->value->column)&&strpos($_smarty_tpl->tpl_vars['option']->value->column,"0")!==false||!isset($_smarty_tpl->tpl_vars['colsetting']->value)) {?>checked="checked"<?php }?> value="0"/>
...
<?php } elseif ($_smarty_tpl->tpl_vars['view']->value=='detail') {?>
    <div class="panel clearfix" >
        <h3><i class="icon-list-ul"></i><?php echo smartyTranslate(array('s'=>' Layout Configure','mod'=>'oviclayoutbuilder'),$_smarty_tpl);?>
</h3>
