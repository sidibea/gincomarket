<?php /* Smarty version Smarty-3.1.19, created on 2018-06-08 10:35:16
         compiled from "/home/abdouhanne/www/modules/categorysearch/views/templates/front/product-sort.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12908230675b1a5be4d98c26-42141945%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7d61772e6681bee73a5b8d7fed827666f06b28a5' => 
    array (
      0 => '/home/abdouhanne/www/modules/categorysearch/views/templates/front/product-sort.tpl',
      1 => 1493588693,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12908230675b1a5be4d98c26-42141945',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b1a5be513bc04_32657610',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b1a5be513bc04_32657610')) {function content_5b1a5be513bc04_32657610($_smarty_tpl) {?>
...
<?php if (!isset($_smarty_tpl->tpl_vars['request']->value)) {?>
	...
	<?php }?>
<?php }?>
<form id="productsSortForm" name="productsSortForm" method="get" action="<?php echo addslashes($_smarty_tpl->tpl_vars['link']->value->getModuleLink('categorysearch','catesearch',array(),true));?>
" class="productsSortForm">
    <input type="hidden" id="sort-orderby" name="orderby" value="<?php echo $_smarty_tpl->tpl_vars['orderby']->value;?>
" />
    <input type="hidden" id="sort-orderway" name="orderway" value="<?php echo $_smarty_tpl->tpl_vars['orderWay']->value;?>
" />		<input type="hidden" id="search_category" name="search_category" value="<?php echo $_smarty_tpl->tpl_vars['search_category']->value;?>
" />
    <input type="hidden" name="n" value="<?php echo $_smarty_tpl->tpl_vars['nbn']->value;?>
" />
...
" />
		<?php }?>		
		<select id="selectProductSort1<?php if (isset($_smarty_tpl->tpl_vars['paginationId']->value)) {?>_<?php echo $_smarty_tpl->tpl_vars['paginationId']->value;?>
<?php }?>" class="selectProductSort1 form-control">
