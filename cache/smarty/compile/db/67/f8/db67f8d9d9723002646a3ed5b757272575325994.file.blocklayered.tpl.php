<?php /* Smarty version Smarty-3.1.19, created on 2017-04-28 07:17:07
         compiled from "/home/abdouhanne/www/pr/themes/supershop/modules/blocklayered/blocklayered.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9801625495902ec732845e2-84916030%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'db67f8d9d9723002646a3ed5b757272575325994' => 
    array (
      0 => '/home/abdouhanne/www/pr/themes/supershop/modules/blocklayered/blocklayered.tpl',
      1 => 1492385467,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9801625495902ec732845e2-84916030',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5902ec734db967_31156815',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5902ec734db967_31156815')) {function content_5902ec734db967_31156815($_smarty_tpl) {?>
...
<div id="layered_block_left" class="block">
	...
	<p class="title_block"><?php echo smartyTranslate(array('s'=>'Filter selection','mod'=>'blocklayered'),$_smarty_tpl);?>
</p>
			...
			<div>
				...
				<div id="enabled_filters">
					...
					<span class="layered_subtitle" style="float: none;">
						...
						<?php echo smartyTranslate(array('s'=>'YOU ARE VIEWING','mod'=>'blocklayered'),$_smarty_tpl);?>
...
"><i class="icon-remove"></i></a>
                    ...
                    <a href="javascript:void(0)" data-rel="remove-all" class="remove-all"><?php echo smartyTranslate(array('s'=>'Remove all','mod'=>'blocklayered'),$_smarty_tpl);?>
</a>
...
" style="display: none;">
						...
						<?php } else { ?>
							...
							<div class="layered_filter<?php if (isset($_smarty_tpl->tpl_vars['filter']->value['is_color_group'])&&$_smarty_tpl->tpl_vars['filter']->value['is_color_group']) {?> color_class<?php }?> <?php if ($_smarty_tpl->tpl_vars['filter']->value['type']=='id_attribute_group') {?> size_class<?php }?><?php if ($_smarty_tpl->tpl_vars['filter']->value['type']=='manufacturer') {?> manufacturer_class<?php }?>">
...
?>
										...
										<li class="nomargin <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['fe']['index']>=$_smarty_tpl->tpl_vars['filter']->value['filter_show_limit']) {?>hiddable<?php }?> col-lg-6 <?php if (isset($_smarty_tpl->tpl_vars['value']->value['checked'])) {?> checked <?php }?>">

											<?php if (isset($_smarty_tpl->tpl_vars['filter']->value['is_color_group'])&&$_smarty_tpl->tpl_vars['filter']->value['is_color_group']) {?>

												<input class="color-option <?php if (isset($_smarty_tpl->tpl_vars['value']->value['checked'])&&$_smarty_tpl->tpl_vars['value']->value['checked']) {?>on<?php }?> <?php if (!$_smarty_tpl->tpl_vars['value']->value['nbr']) {?>disable<?php }?>" value="<?php echo $_smarty_tpl->tpl_vars['value']->value['color'];?>
" type="button" name="layered_<?php echo $_smarty_tpl->tpl_vars['filter']->value['type_lite'];?>
_<?php echo $_smarty_tpl->tpl_vars['id_value']->value;?>
...
<?php }?>"<?php if (isset($_smarty_tpl->tpl_vars['value']->value['checked'])) {?> checked="checked"<?php }?><?php if (!$_smarty_tpl->tpl_vars['value']->value['nbr']) {?> disabled="disabled"<?php }?> />
											...
											<label 
												for="layered_<?php echo $_smarty_tpl->tpl_vars['filter']->value['type_lite'];?>
_<?php echo $_smarty_tpl->tpl_vars['id_value']->value;?>
"
												...
												<?php } else { ?>
													<?php if (isset($_smarty_tpl->tpl_vars['filter']->value['is_color_group'])&&$_smarty_tpl->tpl_vars['filter']->value['is_color_group']) {?> 
														class="layered_color <?php if (isset($_smarty_tpl->tpl_vars['value']->value['checked'])&&$_smarty_tpl->tpl_vars['value']->value['checked']) {?>on<?php }?>" data-rel="<?php echo $_smarty_tpl->tpl_vars['id_value']->value;?>
_<?php echo $_smarty_tpl->tpl_vars['filter']->value['id_key'];?>
"
													<?php }?>
												<?php }?>
...
<?php if ($_smarty_tpl->tpl_vars['layered_show_qties']->value) {?><span> (<?php echo $_smarty_tpl->tpl_vars['value']->value['nbr'];?>
												...
												<?php if (!isset($_smarty_tpl->tpl_vars['filter']->value['is_color_group'])||!$_smarty_tpl->tpl_vars['filter']->value['is_color_group']) {?> 
													...
													<?php if ($_smarty_tpl->tpl_vars['filter']->value['type']!='category'&&$_smarty_tpl->tpl_vars['filter']->value['type']!='id_feature'&&$_smarty_tpl->tpl_vars['filter']->value['type']!='quantity'&&$_smarty_tpl->tpl_vars['filter']->value['type']!='condition'&&$_smarty_tpl->tpl_vars['filter']->value['type']!='manufacturer') {?>
														<span class="filter-size-box <?php if (isset($_smarty_tpl->tpl_vars['value']->value['checked'])) {?> active <?php }?>"> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['value']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</span>
													<?php } else { ?>
...
?>
										...
										<li class="nomargin <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['fe']['index']>=$_smarty_tpl->tpl_vars['filter']->value['filter_show_limit']) {?>hiddable<?php }?>">
											...
											<?php if (isset($_smarty_tpl->tpl_vars['filter']->value['is_color_group'])&&$_smarty_tpl->tpl_vars['filter']->value['is_color_group']) {?>
												...
												<input class="radio color-option <?php if (isset($_smarty_tpl->tpl_vars['value']->value['checked'])&&$_smarty_tpl->tpl_vars['value']->value['checked']) {?>on<?php }?> <?php if (!$_smarty_tpl->tpl_vars['value']->value['nbr']) {?>disable<?php }?>" type="button"  data-rel="<?php echo $_smarty_tpl->tpl_vars['id_value']->value;?>
_<?php echo $_smarty_tpl->tpl_vars['filter']->value['id_key'];?>
" id="layered_id_attribute_group_<?php echo $_smarty_tpl->tpl_vars['id_value']->value;?>
" <?php if (!$_smarty_tpl->tpl_vars['value']->value['nbr']) {?>disabled="disabled"<?php }?> style="background: <?php if (isset($_smarty_tpl->tpl_vars['value']->value['color'])) {?><?php if (file_exists((@constant('_PS_ROOT_DIR_')).("/img/co/".((string)$_smarty_tpl->tpl_vars['id_value']->value).".jpg"))) {?>url(img/co/<?php echo $_smarty_tpl->tpl_vars['id_value']->value;?>
.jpg)<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['value']->value['color'];?>
...
<?php if ($_smarty_tpl->tpl_vars['layered_show_qties']->value) {?><span> (<?php echo $_smarty_tpl->tpl_vars['value']->value['nbr'];?>
												...
												<?php } else { ?>
													...
													<a href="<?php echo $_smarty_tpl->tpl_vars['value']->value['link'];?>
"<?php if (trim($_smarty_tpl->tpl_vars['value']->value['rel'])!='') {?> data-rel="<?php echo $_smarty_tpl->tpl_vars['value']->value['rel'];?>
"<?php }?>><?php if ((($_smarty_tpl->tpl_vars['filter']->value['type']=='id_attribute_group')&&(isset($_smarty_tpl->tpl_vars['filter']->value['is_color_group'])&&!$_smarty_tpl->tpl_vars['filter']->value['is_color_group']))) {?> <span class="size_span"><?php }?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['value']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
<?php if ((($_smarty_tpl->tpl_vars['filter']->value['type']=='id_attribute_group')&&(isset($_smarty_tpl->tpl_vars['filter']->value['is_color_group'])&&!$_smarty_tpl->tpl_vars['filter']->value['is_color_group']))) {?></span><?php }?><?php if ($_smarty_tpl->tpl_vars['layered_show_qties']->value) {?><span> (<?php echo $_smarty_tpl->tpl_vars['value']->value['nbr'];?>
)</span><?php }?></a>
