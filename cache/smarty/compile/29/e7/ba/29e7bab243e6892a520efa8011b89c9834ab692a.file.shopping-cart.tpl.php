<?php /* Smarty version Smarty-3.1.19, created on 2018-06-08 00:16:49
         compiled from "/home/abdouhanne/www/themes/supershop/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4310495785b19caf1629c24-26723177%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '29e7bab243e6892a520efa8011b89c9834ab692a' => 
    array (
      0 => '/home/abdouhanne/www/themes/supershop/shopping-cart.tpl',
      1 => 1493588700,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4310495785b19caf1629c24-26723177',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b19caf3bee779_60278761',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b19caf3bee779_60278761')) {function content_5b19caf3bee779_60278761($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/home/abdouhanne/www/tools/smarty/plugins/modifier.regex_replace.php';
...
<?php if (!isset($_smarty_tpl->tpl_vars['empty']->value)&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>		<div class="heading-counter warning"><?php echo smartyTranslate(array('s'=>'Your shopping cart contains:'),$_smarty_tpl);?>
...
</th>					<th class="cart_delete last_item"><i class="icon-trash" style="font-size: 22px;"></i></th>				</tr>			</thead>			<tfoot>				<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value) {?>					<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value) {?>						<tr class="cart_total_price">							                            <td rowspan="<?php echo 2+$_smarty_tpl->tpl_vars['total_discounts_num']->value+$_smarty_tpl->tpl_vars['use_show_taxes']->value+$_smarty_tpl->tpl_vars['total_wrapping_taxes_num']->value;?>
...
</div>	<p class="cart_navigation clearfix">		<?php if (!$_smarty_tpl->tpl_vars['opc']->value) {?>			<a				href="<?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,'step=1&amp;back={$back}'), ENT_QUOTES, 'UTF-8', true);?>
...
<i class="icon-chevron-right right"></i></span>			</a>		<?php }?>		<a			href="<?php if ((isset($_SERVER['HTTP_REFERER'])&&strstr($_SERVER['HTTP_REFERER'],'order.php'))||isset($_SERVER['HTTP_REFERER'])&&strstr($_SERVER['HTTP_REFERER'],'order-opc')||!isset($_SERVER['HTTP_REFERER'])) {?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('index');?>
