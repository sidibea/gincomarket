...
class posproductcategory extends Module {
	private $spacer_size = '5';	
	private $_postErrors  = array();
	private $_html= null;
	public function __construct() {
		$this->name 		= 'posproductcategory';
		$this->tab 			= 'front_office_features';
		$this->version 		= '1.5';
		$this->author 		= 'posthemes';
		$this->displayName 	= $this->l('Pos Category Products Slider');
		$this->description 	= $this->l('Category Products Slider');
		parent :: __construct();
	...
	Configuration::updateGlobalValue($this->name . '_list_cate',$cateDefault);
      ...
      public function uninstall() {
        ...
        $this->_clearCache('posproductcategory.tpl');
    ...
    public function hookHeader($params){
        if ($this->psversion()==5){
            ...
            Tools::addCSS(($this->_path).'posproductcategory.css');
	...
	public function hookblockPosition1($params) {
		...
		return $this->display(__FILE__, 'posproductcategory.tpl');
	}
