...
<div class="col-xs-12 col-lg-2 clearfix{if $PS_CATALOG_MODE} header_user_catalog{/if}">
{/if}
	<div class="shopping_cart">
		<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
			{l s='My Cart' mod='blockcart'}&nbsp;(<span class="ajax_cart_quantity">{$cart_qties}</span>)
		</a>
		{if !$PS_CATALOG_MODE}
