...
<html{if isset($language_code) && $language_code} lang="{$language_code|escape:'html':'UTF-8'}"{/if}>
	<head>
		...
		{$HOOK_HEADER}
		<link href="http{if Tools::usingSecureMode()}s{/if}://fonts.googleapis.com/css?family=Khula:300,400,600,700,800&amp;subset=latin,devanagari,latin-ext" rel="stylesheet" type="text/css" media="all">
