	...
	if (view == 'list')
	{
		...
		$('.product_list > li').each(function(index, element) {
			...
			html = '<div class="product-container"><div class="row">';
				html += '<div class="col-xs-12 col-sm-4 col-md-3"><div class="left-block">' + $(element).find('.left-block').html() + '</div></div>';
				html += '<div class="col-xs-12 col-sm-8 col-md-9"><div class="right-block">';
