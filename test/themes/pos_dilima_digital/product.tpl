...
<div itemscope itemtype="http://schema.org/Product">
					...
					<div>
						<p id="old_price"{if (!$product->specificPrice || !$product->specificPrice.reduction)} class="hidden"{/if}>{strip}
							{if $priceDisplay >= 0 && $priceDisplay <= 2}
								...
								<span id="old_price_display"><span class="old_price">{if $productPriceWithoutReduction > $productPrice}{convertPrice price=$productPriceWithoutReduction|floatval}{/if}</span>{if $tax_enabled && $display_tax_label == 1} {if $priceDisplay == 1}{l s='tax excl.'}{else}{l s='tax incl.'}{/if}{/if}</span>
							{/if}
						{/strip}</p>
							...
							<ul id="usefull_link_block" class="clearfix no-print">
								...
								<li class="print">
									<a href="javascript:print();">
										<i class="icon-print"></i>{l s='Print'}
									</a>
								</li>
	...
	{if !$content_only}
		{if (isset($product) && $product->description) || (isset($features) && $features) || (isset($quantity_discounts) && count($quantity_discounts) > 0) || (isset($HOOK_PRODUCT_TAB) && $HOOK_PRODUCT_TAB) || (isset($attachments) && $attachments) || isset($product) && $product->customizable}
<div id="more_info_block" class="clear">
	<div class="row">
		<div class="col-xs-12 col-md-3 header_tab">
			<ul id="more_info_tabs" class="idTabs idTabsShort clearfix">
				{if $product->description}<li><a id="more_info_tab_more_info" href="#idTab1">{l s='More info'}</a></li>{/if}
				{if $features}<li><a id="more_info_tab_data_sheet" href="#idTab2">{l s='Data sheet'}</a></li>{/if}
				{if $accessories}<li><a id="more_info_tab_data_sheet" href="#idTab3">{l s='accessories'}</a></li>{/if}
		...
		<div class="col-xs-12 col-md-9 content_tab">
   ...
   {if isset($features) && $features}
		...
		{if isset($accessories) && $accessories}
			<!--Accessories -->
			<section id="idTab3" class="accessories-block-out">
				<div class="accessories-block-content">
					<div class="row">
						<div class="accessories-block-slider">
