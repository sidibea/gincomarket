...
{if isset($products) && $products|@count >0}
	<div id="product-list-{$module_id}-{$feature}-{$item_id}" class="section-products lazy-carousel check-active {if isset($active) && $active == '1'}active{/if} tab-content-{$module_id}-{$feature}-{$item_id}">
