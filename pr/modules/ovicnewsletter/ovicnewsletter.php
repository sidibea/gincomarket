       ...
       if($persistent == 0){
            if (!$this->isCached('ovicnewsletter.tpl'))
    		{
				...
				if(Tools::usingSecureMode())
					$ovicNewsletterUrl = _PS_BASE_URL_SSL_.__PS_BASE_URI__.'modules/'.$this->name;
				else
					$ovicNewsletterUrl = _PS_BASE_URL_.__PS_BASE_URI__.'modules/'.$this->name;
    			$this->context->smarty->assign(array('newsletter_setting'=>$item, 'ovicNewsletterUrl'=>$ovicNewsletterUrl));
    		}
