<div class="panel">
    <div class="panel-heading">
		...
		<span class="panel-heading-action">
            <a href="javascript:void(0)" onclick="showModal('modalMenu', '')" class="list-toolbar-btn link-add" title="{l s='Add new' mod='verticalmegamenus'}"><i class="process-icon-new"></i></a>
		</span>
    </div>
...
<div class="panel" id="panel-list-group" style="display:none">
    <div class="panel-heading">
		...
		<span class="panel-heading-action">
            <a href="javascript:void(0)" onclick="showModal('modalGroup', '')" class="list-toolbar-btn link-add" title="{l s='Add new' mod='verticalmegamenus'}"><i class="process-icon-new"></i></a>
		</span>
    </div>
    <div class="panel-body" style="padding:0">
        <div class="table-responsive">
...
<div class="panel" id="panel-list-menu-item" style="display:none">
    <div class="panel-heading">
		...
		<span class="panel-heading-action">
            <a href="javascript:void(0)" onclick="showModal('modalMenuItem', '')" class="list-toolbar-btn link-add" title="{l s='Add new' mod='verticalmegamenus'}"><i class="process-icon-new"></i></a>
		</span>
    </div>
    <div class="panel-body" style="padding:0">
        <div class="table-responsive">
