...
$(document).ready(function(){
    var animated = new Array('animated fadeInDown' , 'animated slideInLeft', 'animated slideInRight', 'animated zoomIn', 'animated fadeInUp', 'animated fadeInDown');
	...
	if (!!$.prototype.bxSlider)
		$('#homeslider').bxSlider({
            ...
            onSliderLoad: function(currentIndex) {
                $('.homeslider-description').eq(currentIndex).find(".custom-animated").each(function(index) {
