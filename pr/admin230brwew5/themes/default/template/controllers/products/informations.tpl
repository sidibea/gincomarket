...
<div id="product-informations" class="panel product-tab">
	...
	{if isset($agilemultipleseller_isinstalled) && $agilemultipleseller_isinstalled}{include file="$agilemultipleseller_hook./hook_product_information.tpl"}{/if}{if isset($agilesellerlistoptions_isinstalled) && $agilesellerlistoptions_isinstalled}{include file="$agilesellerlistoptions_hook./hook_product_information.tpl"}{/if}
